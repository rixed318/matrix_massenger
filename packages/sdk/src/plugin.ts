...
export type PluginEventHandler<K extends PluginEventName> = (
  payload: MessengerEvents[K],
) => void | Promise<void>;
...
export type CommandHandlerResult = void | string | { message?: string };
...
export const definePlugin = <T extends PluginDefinition>(definition: T): T => definition;
