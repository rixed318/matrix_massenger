...
export const spacing: SizeScale<number> = {
  xs: 4,
  sm: 8,
  md: 12,
  lg: 16,
...
export const radii: SizeScale<number> = {
  xs: 8,
  sm: 12,
  md: 16,
  lg: 20,
...
export const controls: ControlScale<number> = {
  sm: 40,
  md: 44,
  lg: 48,
};

export const typography: TypographyScale<number> = {
  fontFamily: {
...
export const themes: Record<'dark' | 'light' | 'midnight', ThemeTokens<string, number>> = {
  dark: {
    colors: {
      background: {
        primary: '#0B1526',
